...
For `$team-dev` implementation work, read [test and acceptance contract](references/test-acceptance-contract.md). Its `scripts/stage-verification.ps1` intentionally creates and archives Git-tracked verification packets inside the target project.
